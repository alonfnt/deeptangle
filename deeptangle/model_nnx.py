"""
Flax NNX-based implementation of the DeepTangle model.

This uses the new Flax NNX API for better Hugging Face Hub compatibility
and simpler model definition compared to Linen.
"""
